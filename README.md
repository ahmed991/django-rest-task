...
For full request/response details and edge cases see [DETAILED_README.md](https://github.com/ahmed991/django-rest-task/blob/assignment-django/UPDATED_README.md).
